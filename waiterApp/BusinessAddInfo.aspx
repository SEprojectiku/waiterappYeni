<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessAddInfo.aspx.cs" Inherits="waiterApp.BusinessAddInfo" %>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <asp:Label runat="server"  ID="success" Text="You have successfully added your infos"></asp:Label>
          <asp:Label runat="server" ID="fail" Text="Check your values again please"></asp:Label>
      </div>
